...
<h4>Cloud deployed LLM-based application developed for information management and retrieval at CERN. It helps users querying a complex database through natural language and interacting with various web applications used in the TE (Technology) department for technical tasks, mainly TRAP (Test Results Analysis Platform).
...
<img src="img/TRAP8.png" width="500" style="text-align: center" /> <hr> 
